...
public class RouteParamItem extends BaseItem<Integer> {
    ...
    private View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (listener != null) {
                listener.onEditReq(tv.getText().toString(),
                        whichIdInput == R.id.input1 ? Type.STRING : data);
            }
        }
    };
    ...
    public void onBinding(final int position, UniversalAdapter.ViewPool pool, Integer data) {
        ...
        pool.setText(R.id.type, getTypeName(data)).setText(R.id.input1, input1).setText(R.id.input2,
                input2);
    ...
    @IntDef({Type.NONE, Type.STRING, Type.BOOLEAN, Type.INT, Type.LONG, Type.FLOAT, Type.DOUBLE,})
