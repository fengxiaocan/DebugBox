...
public class KeyValueItem extends BaseItem<String[]> {
    ...
    public void onBinding(int position, UniversalAdapter.ViewPool pool, String[] data) {
        ...
        pool.setTextGravity(R.id.item_key, isTitle ? Gravity.CENTER : Gravity.CENTER_VERTICAL)
            .setText(R.id.item_key, data[0])
            .setTextGravity(R.id.item_value, isTitle ? Gravity.CENTER : Gravity.CENTER_VERTICAL)
