...
public class NetContentFragment extends BaseFragment {
    ...
    private void setSearchView() {
        ...
        searchItem.setActionView(searchView = new SearchView(getContext())).setIcon(
                R.drawable.pd_search).setShowAsAction(
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewKnife.dip2px(32),
