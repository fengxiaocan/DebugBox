...
public class Config {
    ...
    private static SharedPreferences getSp() {
        return BoxUtils.getApplication().getSharedPreferences(NAME, Context.MODE_PRIVATE);
    }
    ...
    @IntDef({Type.SHAKE_SWITCH, Type.SHAKE_THRESHOLD, Type.COMMON_NETWORK_SWITCH,
            Type.COMMON_SANDBOX_SWITCH, Type.COMMON_UI_SWITCH, Type.NETWORK_DELAY_REQ,
            Type.NETWORK_DELAY_RES, Type.NETWORK_PAGE_SIZE, Type.NETWORK_URLCONNECTION,
            Type.SANDBOX_DPM, Type.UI_ACTIVITY_GRAVITY, Type.UI_GRID_INTERVAL,
