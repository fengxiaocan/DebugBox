...
import com.box.libs.inspector.canvas.ClickInfoCanvas;
import com.box.libs.inspector.canvas.GridCanvas;
import com.box.libs.inspector.canvas.RelativeCanvas;
import com.box.libs.inspector.canvas.SelectCanvas;
import com.box.libs.inspector.model.Element;
...
public class OperableView extends ElementHoldView {
    ...
    private Runnable tapTimeoutCheck = new Runnable() {
        ...
        public void run() {
            ...
            gridAnimator = ObjectAnimator.ofFloat(0, 1).setDuration(longPressTimeout - tapTimeout);
    ...
    @IntDef({State.NONE, State.TOUCHING, State.PRESSING, State.DRAGGING,})
