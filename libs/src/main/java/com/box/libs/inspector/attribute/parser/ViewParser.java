...
public class ViewParser implements IParser<View> {
    ...
    public List<Attribute> getAttrs(View view) {
        ...
        Attribute classAttribute = new Attribute("class", view.getClass().getName());
        ...
        Attribute widthAttribute = new Attribute("layout_width",
                formatLayoutParam(params.width, view.getWidth()), Attribute.Edit.LAYOUT_WIDTH);
        attributes.add(widthAttribute);
        Attribute heightAttribute = new Attribute("layout_height",
                formatLayoutParam(params.height, view.getHeight()), Attribute.Edit.LAYOUT_HEIGHT);
        attributes.add(heightAttribute);

        Attribute visibilityAttribute = new Attribute("visibility",
                formatVisibility(view.getVisibility()), Attribute.Edit.VISIBILITY);
        attributes.add(visibilityAttribute);

        Attribute paddingLeftAttribute = new Attribute("paddingLeft",
                ViewKnife.px2dipStr(view.getPaddingLeft()), Attribute.Edit.PADDING_LEFT);
        attributes.add(paddingLeftAttribute);
        Attribute paddingTopAttribute = new Attribute("paddingTop",
                ViewKnife.px2dipStr(view.getPaddingTop()), Attribute.Edit.PADDING_TOP);
        attributes.add(paddingTopAttribute);
        Attribute paddingRightAttribute = new Attribute("paddingRight",
                ViewKnife.px2dipStr(view.getPaddingRight()), Attribute.Edit.PADDING_RIGHT);
        attributes.add(paddingRightAttribute);
        Attribute paddingBottomAttribute = new Attribute("paddingBottom",
                ViewKnife.px2dipStr(view.getPaddingBottom()), Attribute.Edit.PADDING_BOTTOM);
            ...
            view.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)
        {
            ...
            Attribute marginLeftAttribute = new Attribute("marginLeft",
                    ViewKnife.px2dipStr(marginLayoutParams.leftMargin), Attribute.Edit.MARGIN_LEFT);
            attributes.add(marginLeftAttribute);
            Attribute marginTopAttribute = new Attribute("marginTop",
                    ViewKnife.px2dipStr(marginLayoutParams.topMargin), Attribute.Edit.MARGIN_TOP);
            attributes.add(marginTopAttribute);
            Attribute marginRightAttribute = new Attribute("marginRight",
                    ViewKnife.px2dipStr(marginLayoutParams.rightMargin),
                    Attribute.Edit.MARGIN_RIGHT);
            attributes.add(marginRightAttribute);
            Attribute marginBottomAttribute = new Attribute("marginBottom",
                    ViewKnife.px2dipStr(marginLayoutParams.bottomMargin),
                    Attribute.Edit.MARGIN_BOTTOM);
            attributes.add(marginBottomAttribute);
        }

        Attribute translationXAttribute = new Attribute("translationX",
                ViewKnife.px2dipStr(view.getTranslationX()));
        attributes.add(translationXAttribute);
        Attribute translationYAttribute = new Attribute("translationY",
                ViewKnife.px2dipStr(view.getTranslationY()));
        attributes.add(translationYAttribute);

        Attribute backgroundAttribute = new Attribute("background",
                formatDrawable(view.getBackground()));
        attributes.add(backgroundAttribute);
        Attribute alphaAttribute = new Attribute("alpha", String.valueOf(view.getAlpha()),
                Attribute.Edit.ALPHA);
        ...
        Attribute longClickableAttribute = new Attribute("longClickable",
                String.valueOf(view.isLongClickable()));
        ...
        Attribute contentDescriptionAttribute = new Attribute("contentDescription",
