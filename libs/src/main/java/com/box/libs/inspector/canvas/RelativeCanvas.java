package com.box.libs.inspector.canvas;
...
public class RelativeCanvas {
    ...
    private void drawLineWithEndPoint(Canvas canvas, int startX, int startY, int endX, int endY) {
        ...
        if (startX == endX) {
            canvas.drawLine(startX - endPointSpace, startY, endX + endPointSpace, startY,
                    areaPaint);
            canvas.drawLine(startX - endPointSpace, endY, endX + endPointSpace, endY, areaPaint);
        } else if (startY == endY) {
            canvas.drawLine(startX, startY - endPointSpace, startX, endY + endPointSpace,
                    areaPaint);
