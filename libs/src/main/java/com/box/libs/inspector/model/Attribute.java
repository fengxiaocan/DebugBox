...
public class Attribute {
    ...
    @IntDef({Edit.NORMAL, Edit.LAYOUT_WIDTH, Edit.LAYOUT_HEIGHT, Edit.VISIBILITY, Edit.PADDING_LEFT,
            Edit.PADDING_RIGHT, Edit.PADDING_TOP, Edit.PADDING_BOTTOM, Edit.ALPHA, Edit.TEXT,
            Edit.TEXT_COLOR, Edit.TEXT_SIZE, Edit.SCALE_TYPE, Edit.MARGIN_LEFT, Edit.MARGIN_RIGHT,
            Edit.MARGIN_TOP, Edit.MARGIN_BOTTOM,})
