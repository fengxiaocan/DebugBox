...
public final class Databases {
    ...
    private boolean bindDriver(IDriver<? extends IDescriptor> driver,
    ...
    public DatabaseResult query(int databaseId, String table, String condition) {
        ...
        String sql = String.format(
                "select " + Column.ROW_ID + " as " + Column.ROW_ID + ", * from %s", table);
    ...
    public DatabaseResult update(int databaseId, String table, String primaryKey,
            String primaryValue, String key, String value)
    {
        String sql = String.format("update %s set %s = '%s' where %s = '%s'", table, key, value,
    ...
    public DatabaseResult insert(int databaseId, String table, ContentValues values) {
        ...
        String sql = String.format("insert into %s (%s) values (%s)", table, keyBuilder.toString(),
                valueBuilder.toString());
        return executeSQL(databaseId, sql);
    }

    public DatabaseResult delete(int databaseId, String table, String primaryKey,
            String primaryValue)
    {
