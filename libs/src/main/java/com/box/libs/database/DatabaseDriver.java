...
import com.box.libs.database.protocol.IProvider;
...
public class DatabaseDriver implements IDriver<DatabaseDescriptor> {
    ...
    private static final String[] EXTRA_FILE_SUFFIXES =
    ...
    private static List<File> tidyDatabaseList(List<File> databaseFiles) {
        ...
        for (File databaseFile : databaseFiles) {
            ...
            if (sansSuffix.equals(databaseFilename) || !originalAsSet.contains(
                    new File(sansSuffix)))
            {
